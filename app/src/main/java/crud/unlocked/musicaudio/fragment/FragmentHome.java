...
/**
 * Created by Irelia on 12/29/2016.
 */

public class FragmentHome extends Fragment {

    public static final String TAG = "FragmentRecent";
    ...
    private void requestChartsByGenre() {
        pb_main_loader.setVisibility(View.VISIBLE);
        String url = SoundCloud.buildUrl("top", MyConfig.ALL_MUSIC, "50");
